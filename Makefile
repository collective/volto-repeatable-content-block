...
ADDON_NAME='@plone-collective/volto-repeatable-content-block'
ADDON_PATH='volto-repeatable-content-block'
...
pull-backend-image:  ## Pulls and updates the backend image (for use it while developing)
	docker pull ghcr.io/plone-collective/voltorepeatable-content-block:latest
